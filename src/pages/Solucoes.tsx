      ...
      <div className="container" ref={ref}>
        <div className="servicos__grid servicos__grid--2col">
          <Link to="/solucoes/restaurante-marmitas" className="card-servico-big fade-in-up">
            <div className="card-servico-big__img">🍽️</div>
          ...
          <Link to="/solucoes/refeicoes-corporativas" className="card-servico-big fade-in-up" style={{ transitionDelay: '100ms' }}>
            <div className="card-servico-big__img">🏢</div>
    ...
    <section className="servicos">
      <div className="container" ref={ref}>
        ...
        <div className="servicos__grid servicos__grid--3col">
          {[
            { icon: '🚚', title: 'Frota Própria', text: 'Veículos dedicados exclusivamente ao transporte de refeições, garantindo pontualidade e rastreabilidade.' },
            { icon: '🔥', title: 'Hot Box', text: 'Sistema de transporte térmico que mantém as refeições na temperatura ideal até o momento do consumo.' },
            { icon: '📍', title: 'Joinville e Região', text: 'Entregas diárias em toda Joinville e cidades vizinhas, incluindo fins de semana e feriados.' },
          ].map((s, i) => (
